...
**Description**: let's build an app called claude engineer. Claude engineer is an app to build websites with natural language.  It's an app where users can have projects where each project is made of chat conversation between a user and an AI. 
...
```sh
git clone https://github.com/GPT-Engineer-App/chat-weaver.git
cd chat-weaver
npm i
